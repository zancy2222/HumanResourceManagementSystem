...
// Update the query to fetch attachments from the 'Attachments' table
$query = "SELECT a.id, u.firstname, u.middlename, u.surname, a.file_name, a.file_path, a.upload_date
          FROM Attachments a
...
<body>
    <div class="sidebar">
        ...
        <div class="nav-item active" data-tooltip="Applicant Additional Attachments">

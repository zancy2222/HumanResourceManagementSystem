...
// Updated query to fetch employee details from the 'Employee', 'ArchiveApplicant', and 'Users' tables
$query = "
    SELECT 
        e.employee_id, 
        u.firstname, 
...
<body>
    <div class="sidebar">
        ...
        <a href="Employee.php">
            <div class="nav-item active" data-tooltip="Employee">
                <img width="96" height="96" src="https://img.icons8.com/?size=100&id=20318&format=png&color=C44100" alt="employee" />
            </div>
        </a>
    ...
    <div class="status-box">
        ...
        <div class="table-container">
            ...
            <table>
                <thead>
                    <tr>
                        <th>Employee ID</th> <!-- Display Employee ID -->
                        <th>Full Name</th>
                        <th>Email</th>
                        <th>Phone</th>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $status = htmlspecialchars($row['status']); // New field
         ...
         <td>$subject</td>
         <td>$status</td>
         <td><button class='view-btn' onclick='openViewModal(\"" . $row['employee_id'] . "\")'>View</button></td>
     </tr>";
                        }
                    } else {
                        echo "<tr><td colspan='7'>No records found</td></tr>"; // Updated colspan to match number of columns
                    }
                    ?>
                </tbody>
            </table>
...
function openViewModal(id) {
    fetch('Partials/get_employee_details.php?id=' + encodeURIComponent(id))
        ...
        .then(data => {
            if (data) {
                ...
                employeeDetails.innerHTML = `
                    ...
                    <p><strong>Progress Status:</strong> ${data.progress_status}</p>
